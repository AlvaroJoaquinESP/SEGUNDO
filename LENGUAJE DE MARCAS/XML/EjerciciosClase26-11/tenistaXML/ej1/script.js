function procesarXML(file){
    ...
    for (const tenista of tenistas) {
        ...
        const cells = [tenista.querySelector("nombre").textContent,
        tenista.querySelector("nacimiento").textContent,
        tenista.querySelector("nacionalidad").textContent,
        tenista.querySelector("ranking").textContent,
        tenista.querySelector("titulos").textContent]
